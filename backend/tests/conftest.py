...
ADMIN_ENDPOINTS = [
    ...
    ("GET", "/api/system/1/updates"),
    ("POST", "/api/system/1/updates/install"),
    ("GET", "/api/system/1/backups"),
    ("POST", "/api/system/1/backups"),
    ("GET", "/api/system/1/backups/1/download"),
    ("DELETE", "/api/system/1/backups/1"),
    ("GET", "/api/system/1/logs"),
    ("GET", "/api/system/1/log-files"),
    ("GET", "/api/system/1/log-files/1"),
    ("GET", "/api/system/1/tasks"),
    ("POST", "/api/system/1/tasks/run"),
    ("POST", "/api/system/1/restart"),
    ("GET", "/api/suggestions/availability"),
    ("GET", "/api/suggestions"),
    ("POST", "/api/suggestions/decide"),
